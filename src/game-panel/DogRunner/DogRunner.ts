...
export class Game{
  ...
  width:number=0;
  height:number=0;
  size:number=1;dL:number=1;loadedImg:number;resourceCount:number;base:number=0;
  ...
  constructor (canvas:any, sound:any=0){
    ...
    this.entitiesImg={
      background:{
        self : "./DogRunner/background.png"
      },
      player:{
        self :"./DogRunner/Dog.png",
        // sheild : "./SpaceEscape/sheild.png",
        // gun : "./SpaceEscape/bat.png"
      },
      enemies:{
        self : "./BallonShooter/Enemy.png",
  ...
  constructor (game:Game, canvas:any) {
    ...
    window. addEventListener ("mousedown", () =>{
      if(this.game.state==STATE.Running)
        this.game.entities.player && this.game.entities.player.jump();
    });
